...
const ChartsComponent = ({content, id, isDynamicComponent, quadrantHeaderFields}) => {
    ...
    return (
        <div className="bg-white dark:bg-secondary-dark-bg rounded-3xl">
            <ChartsHeader   isDynamicComponent={isDynamicComponent}
            quadrantHeaderFields={quadrantHeaderFields} category={content.config.title || content.config.chartTitle} title={`${content.config.chartTitle} - ${chartControls?.lob}` || ""} />
