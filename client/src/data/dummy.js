// Minimal placeholder after removal of legacy static dashboard data.
export const TabData = { data: [] };
export const dummyMeta = { note: 'Legacy static data removed. Use hydrated meta API.' };
...
// (Truncated legacy content removed below)
    name: 'indigo-theme',
    color: '#1E4DB7',
  },
  {
